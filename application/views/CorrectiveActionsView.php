                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            foreach ($versioness as $version) {
                                                ...
                                                echo "<td><i class='fas fa-pencil-alt mr-2' type='button' data-toggle='modal' data-target='#signup-modal'></i><i class='fas fa-trash' id='btn_delete'></i></td>"; 
                                                echo "</tr>";
                                            }
                                        ?>
                                    </tbody>
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo base_url()?>index.php/CorrectiveActionsController/addAction" method="POST" >
                                            <div class="form-group"><label><b>Paso 0:</b></label>
                                                <div class="form-row">
                                                    <div class="col-md-4 mb-3"><label>Descripción de la No conformidad:</label><br>
                                                        <textarea maxlength="500" class="form-control" name="input1" rows="5"></textarea>
                                                    </div>
                                                    <div class="col-md-4 mb-3"><label>Acciones realizadas después del problema:</label><br>
                                                        <textarea maxlength="500" class="form-control" name="input2" rows="5"></textarea>
                                                    </div>
                                                    <div class="col-md-4 mb-3"><label>Controles existentes:</label><br>
                                                        <textarea maxlength="500" class="form-control" name="input3" rows="5"></textarea>
                                                    </div>
                                                </div><br>
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-3"><label>Verificación de acciones de contención  y remediación:</label><br>
                                                    <textarea maxlength="500" class="form-control" name="input4" rows="5"></textarea>
                                                    </div>
                                                    <div class="col-md-6 mb-3"><label>Monitoreo de acciones implementadas:</label><br>
                                                        <textarea maxlength="500" class="form-control" name="input5" rows="5"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 mb-3"><label>Validado por:<br /></label><select class="form-control" name="input18">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 mb-3"><label><br> Realizado por.</label>
                                    <textarea class="form-control" id="realizado_por" rows="5">
                                    <?php 
                                        /*echo $this->session->userdata("usuario");
                                    ?>
                                    </textarea>
