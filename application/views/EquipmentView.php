        ...
        <div class="box">
            <div class="box-header with-border">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-3 mb-3 d-flex" style="flex-direction:column;justify-content: flex-end;">
                ...
                <div class="table-responsive-sm">
                    <table class="table table-striped table-hover text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>06/08/2020</td>
                                <td>1</td>
                                <td><i title="Actualizar" class="fas fa-pencil-alt mr-2" type="button" data-toggle="modal" data-target="#signup-modal"></i><i title="Eliminar" class="fas fa-trash mr-2" id="btn_delete"></i><i title="Mantenimiento" class="fas fa-people-carry mr-2" type="button" data-toggle="modal" data-target="#signup-modal-mtto"></td>
                            </tr>
                        </tbody>
                    </table>
                    <!-- /.modal actualizar -->
                    ...
                    <!-- /.modal mtto -->
                    <form action="<?php echo site_url() ?>/MaintenanceController/AgregarMantenimiento" method="POST" class="needs-validation" novalidate>
                                        ...
                                        <form class="needs-validation" novalidate>
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-8 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="mtto" placeholder="Descripción" required>
                                                    <div class="invalid-feedback">
