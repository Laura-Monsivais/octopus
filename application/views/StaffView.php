                        ...
                        <form class="needs-validation" novalidate>
                            <div class="form-row">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="validationCustom02" placeholder="Edad"
                                        required>
                                    <div class="invalid-feedback">
                                        Completa Edad.
                                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom03" placeholder="RFC"
                                        required>
                                    <div class="invalid-feedback">
                                        Completa RFC.
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom04" placeholder="Calle"
                                        required>
                                    <div class="invalid-feedback">
                                        Completa Calle.
                                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom04" placeholder="País"
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td><i class="fas fa-pencil-alt mr-2" type="button" data-toggle="modal"
                                                    data-target="#signup-modal"></i><i class="fas fa-trash"
                                                    id="btn_delete"></i></td>
                                        </tr>
                                    </tbody>
