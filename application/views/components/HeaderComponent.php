...
<head>
    ...
    <link href="<?php echo base_url()?>assets/src/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css"
        rel="stylesheet" />
                    ...
                    <div class="navbar-brand">
                        <a href="<?php base_url()?>MainController">
                            <span class="logo-icon"><img
                                    src="<?php echo base_url()?>assets/src/assets/images/logo-icon.png" alt="homepage"
                    ...
                    <ul class="navbar-nav float-right">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown">
                                <span class="ml-2 d-none d-lg-inline-block"><span class="text-dark">usuario</span> <i
                                        data-feather="chevron-down" class="svg-icon"></i></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php base_url()?>UsersPermissionsController"><i
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body" style="text-align: center;">
                        ...
                        <a class="btn btn-info my-2" href="<?php echo site_url()?>/LoginController/logout">Inicia
                            sesión</a>
                    </div>
                </div>
            </div>
